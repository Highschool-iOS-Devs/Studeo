...
extension ARAudience: AgoraRtcEngineDelegate {
    ...
    */
    ...
    - Parameters:
        - engine: [AgoraRtcEngineKit](https://docs.agora.io/en/Video/API%20Reference/oc/Classes/AgoraRtcEngineKit.html) object
        - oldRole: Role that the user switches from: [AgoraClientRole](https://docs.agora.io/en/Video/API%20Reference/oc/Constants/AgoraClientRole.html).
        - newRole: Role that the user switches to: [AgoraClientRole](https://docs.agora.io/en/Video/API%20Reference/oc/Constants/AgoraClientRole.html).
