...
//    @ObservedObject var viewRouter:UserData
...
//            if settings {
//                
//                IntroCustomize(userData: userData, viewRouter: viewRouter, interestSelected: $selectedInterests, isNotOnboarding: false, interests: $interests, settings: $settings, add: $add, groupModel:groupModel)
//                
//            }
//            if error {
//                VStack {
